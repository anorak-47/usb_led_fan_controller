...
typedef enum
{
  ...
  CUSTOM_RQ_DEVICE_NAME_READ      = 5,
  CUSTOM_RQ_DEVICE_NAME_WRITE     = 6,
  ...
  CUSTOM_RQ_FASTLEDACTIVE_READ    = 160,
  CUSTOM_RQ_FASTLEDACTIVE_WRITE   = 161,
  ...
  CUSTOM_RQ_FASTLEDSNSID_READ     = 166,
  CUSTOM_RQ_FASTLEDSNSID_WRITE    = 167,
  CUSTOM_RQ_FASTLEDFPS_READ       = 168,
  CUSTOM_RQ_FASTLEDFPS_WRITE      = 169,
  CUSTOM_RQ_FASTLEDOPTION_READ    = 170,
  CUSTOM_RQ_FASTLEDOPTION_WRITE   = 171,
  CUSTOM_RQ_FASTLEDBRIGHT_READ    = 172,
  CUSTOM_RQ_FASTLEDBRIGHT_WRITE   = 173,
  CUSTOM_RQ_FASTLEDRUNNING_READ   = 174,
  CUSTOM_RQ_FASTLEDRUNNING_WRITE  = 175,
#endif
