...
#define __JOYSTICK_USER_H__
	...
	/* Public Interface - May be used in end-application: */
		/* Macros: */
			...
			#define JOY_LEFT 1                 // TODO: Add mask to indicate joystick left position here

			/** Mask for the joystick being pushed in the right direction. */
			#define JOY_RIGHT 2                 // TODO: Add mask to indicate joystick right position here

			/** Mask for the joystick being pushed in the upward direction. */
			#define JOY_UP 4                   // TODO: Add mask to indicate joystick up position here

			/** Mask for the joystick being pushed in the downward direction. */
			#define JOY_DOWN 8                 // TODO: Add mask to indicate joystick down position here

			/** Mask for the joystick being pushed inward. */
			#define JOY_PRESS 16                // TODO: Add mask to indicate joystick pressed position here
