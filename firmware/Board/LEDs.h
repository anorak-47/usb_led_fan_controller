...
#define __LEDS_USER_H__
	...
	/* Public Interface - May be used in end-application: */
		/* Macros: */
			...
			#define LEDS_LED1  0x01      // TODO: Add mask for first board LED here

			/** LED mask for the second LED on the board. */
			#define LEDS_LED2  0x02      // TODO: Add mask for second board LED here
		...
		/* Inline Functions: */
			...
			{
				DDRD |= (1<<5); PORTD |= (1<<5); // green
				DDRC |= (1<<7); PORTC &= ~(1<<7); // yellow
			}
